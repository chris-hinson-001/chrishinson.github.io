...
/**The purpose of this class is to build a HTML page with a form that collects the details of which book to delete and posts them
 * @author Chris Hinson
 */
public class Delete extends HttpServlet {

    /** The purpose of this function is to build a HTML page with a form that collects the details of which book to delete and post them
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<!DOCTYPE html>"+
                "<html>"+
                "<head>"+
                "<title>Library Delete books Input</title>" +
                "<style>\n" +
                //builds the in page styling
                "\tbody{\n" +
                ...
                "</style>" +
                "</head>" +
                //builds the form to get the ID of the book to be deleted
                "<body>"+
                "<h1>Delete a Record</h1>" +
                "    <div class=\"container\">\n" +
                "      <form name=\"delete\" action=\"DeleteResult\" method=\"post\">\n" +
                "        <div class=\"row\">\n" +
                "          <div class=\"col-25\">\n" +
